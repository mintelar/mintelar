...
import { exists, getAllFilesMatching, isDirectory, readdirOrEmpty, readJsonFile, } from "@nomicfoundation/hardhat-utils/fs";
...
export async function getTemplates() {
    ...
    const templates = await Promise.all(pathsToTemplates.map(async (dirName) => {
        ...
        const matchingFiles = await getAllFilesMatching(pathToTemplate, (f) => {
